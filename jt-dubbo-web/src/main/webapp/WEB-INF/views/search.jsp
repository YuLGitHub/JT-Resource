...
<li class="item-book" bookid="${item.id}">
	<div class="p-img">
		<a target="_blank" href="http://www.jt.com/items/${item.id }.html">
			<img width="160" height="160" data-img="1" data-lazyload="${item.images[0]}" src="${item.images[0]}" />
		</a>
	</div>
	<div class="p-name">
		<a target="_blank" href="http://www.jt.com/items/${item.id }.html">
...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<a href="search.html?q=${query}&page=2" class="next">下一页<b></b></a>
</div>
</div>
</div>
