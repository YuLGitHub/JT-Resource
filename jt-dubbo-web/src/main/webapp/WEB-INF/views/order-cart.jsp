...
<!--shortcut end-->
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="余乐"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="13368237227"/>
		<input type="hidden" name="orderShipping.receiverState" value="重庆"/>
		<input type="hidden" name="orderShipping.receiverCity" value="重庆"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="荣昌区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="西南大学"/>
	</form>
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					  ...
					  <c:set var="count">${cart.num}</c:set>
...
<!--**********商品清单内容列表结束************-->
										...
										<div class="order-summary">
											...
											<div class="statistic fr">
                                                <div class="list"><span><em id="span-skuNum">${count}</em> 件商品，总商品金额：</span><em class="price" id="warePriceId" v="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/>">￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/></em></div>
