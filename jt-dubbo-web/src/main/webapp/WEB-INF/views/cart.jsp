...
<div class="w cart">
	<div class="cart-hd group">
		<h2>我的购物车</h2>
		<!-- <span id="show2" class="fore"> <span>现在&nbsp;</span><a class="btn" href="javascript:goToLogin();"><span class="btn-text">登录</span></a><span>， 您购物车中的商品将被永久保存</span> </span>-->
	</div>
	<div id="show">
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">京淘价</div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去京淘国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去京淘结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
